...
{
ans=ans+"<label id='player"+i+"' for='player"+i+"'><b>Player "+i+" :-</b></label><input autocomplete='off' type='text' placeholder='Player "+i+" Name' name='player"+i+"' required>";
// alert(ans);
}
}
}
...
document.getElementById('t_error').style.color="blue";
e.preventDefault();
$('#t_error').css('color','blue');
