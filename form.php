...
<a id='logout'  href="#" class="btn btn-info btn-sm float-right animated bounceInLeft slow"><span class="glyphicon glyphicon-log-out"></span> Log out</a><br><br>
...
<!-- FORM FOR TEAM EVENT -->
<form id="team" style="display:none" action="#">
<div style= font-family:LittleLordFontleroyNF class="container">
<hr>
...
<input id='l_name' autocomplete="off" type="text" placeholder="Enter Leader Name" name="leader_name" required>
...
<input id="player1" autocomplete="off" type="text" placeholder="Player 1 Name" name="player1" required>
<label  for="player2"><b>Player 2 :-</b></label>
<input id="player2" autocomplete="off" type="text" placeholder="Player 2 Name" name="player2" required>
</div>
<label for="college"><b>College Name :-</b></label>
<input autocomplete="off" list="college" type="text" placeholder="Enter College " name="college" required>
<datalist id="college" style="width: 100px;">
